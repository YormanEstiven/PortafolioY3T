  ...
  return (
    <div className="container-studies" id="estudios">
      <div className="title-studies">
        <h2 style={{ fontSize: "2.4rem" }}>Formación académica</h2>
      </div>
      <section className="section-items">
        <article className="itemStudy">
          ...
          <div className="items--body">
            <h3>Bachiller Técnico en Sistemas</h3>
            <p>
              <strong>Intitución:</strong> Institución Educativa La Paz. <br />
              <strong>Fecha grado:</strong> 03 de diciembre de 2019.
              <br />
              En la institución habían convenios con organismos técnicos en el
              que cual yo hice parte del grupo de Sistemas. <br />
              <br />
              <a href="https://ropass.weebly.com/nuestra-institucion.html">
        ...
        <article className="itemStudy">
          ...
          <div className="items--body">
            ...
            <p>
              <strong>Intitución:</strong> Politécnico Colombiano Jaime Isaza
              Cadavid. <br />
              <strong>Fecha inicio:</strong> Febrero de 2020.
              <br />
              <strong>Fecha grado:</strong> Junio de 2025.
              <br />
              <br />
              <br />
              <a href="https://www.politecnicojic.edu.co/">
        ...
        <article className="itemStudy">
          ...
          <div className="items--body">
            <h3>Certificación desarrollador Frontend</h3>
            <p>
              <strong>Intitución:</strong> Universidad Eafit - Nodo. <br />
              <strong>Fecha grado:</strong> Julio de 2023.
              <br />
              En el departamento de Nodo en Eafit realizo el modulo de
              desarrollador Frontend.
              <br />
              <a href="https://nodoeafit.com/verificar">Nodo</a>
              <br />
        ...
        <article className="itemStudy">
          ...
          <div className="items--body">
            <h3>Certificación desarrollador Backend</h3>
            <p>
              <strong>Intitución:</strong> Universidad Eafit - Nodo. <br />
              <strong>Fecha grado:</strong> Julio de 2023.
              <br />
